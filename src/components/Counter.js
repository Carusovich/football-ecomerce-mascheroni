...
function Counter() {
    ...
    return (
        <div className="card-actions justify-end">
            <label for="custom-input-number" className="w-full text-white-700 text-sm font-semibold">Cantidad</label>
            <div className="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                ...
                <button onClick={addHandler} className="bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-r cursor-pointer">
                    <span className="m-auto text-2xl font-thin">+</span>
                </button>
            </div>
        </div>
